...
- Custom bowls are expressible as a menu item with modifier groups (base choice, toppings, finish, enhancers) — functional, but generic UI compared to our builder.
